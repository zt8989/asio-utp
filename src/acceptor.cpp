...
acceptor::acceptor(boost::asio::io_context& ioc)
    : _ex(ioc.get_executor())
{}

acceptor::acceptor(const executor_type& ex)
    : _ex(ex)
{}

void acceptor::bind(const endpoint_type& ep, boost::system::error_code& ec)
{
    if (_is_open) {
